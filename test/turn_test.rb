...
class TurnTest < Minitest::Test
  ...
  def test_it_has_basic_type_and_winner
    card1 = Card.new(:heart, 'Jack', 11)
    card2 = Card.new(:heart, '10', 10)
  ...
  def test_it_can_make_war_even_with_nil_card_at_rank_2
    card1 = Card.new(:diamond, '10', 10)
    card2 = Card.new(:clubs, '4', 4)
    card4 = Card.new(:heart, '10', 10)
    card5 = Card.new(:diamond, '2', 2)
  ...
  def test_it_can_empty_deck_if_not_enough_cards
    card1 = Card.new(:diamond, '10', 10)
    card2 = Card.new(:heart, '9', 9)
    card3 = Card.new(:diamond, '8', 8)
    card4 = Card.new(:heart, '10', 10)
    ...
    assert_equal :war, turn.type
    turn.pile_cards
    assert_equal [card1, card2, card3, card7], player1.deck.cards
